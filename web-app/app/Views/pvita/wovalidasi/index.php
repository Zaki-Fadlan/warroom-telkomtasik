        ...
        <div class="col-md-12">
            <div class="card card-danger collapsed-card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-4">
                            <label>Rentang Waktu (Stamp Ampser)</label>
                            <!-- Calendar -->
                            <div class="row">
                                <div class="col-sm-6">
                                        ...
                                        $.ajax({
                                            ...
                                            success: function(data) {
                                                ...
                                                $('#tabelValidasi').DataTable({
                                                    ajax: '<?php echo ('PvitaValidasi/ajaxDataTableValidasi'); ?>',
                                                    dom: 'Bfrtip',
                                                    buttons: [
                                                        'copyHtml5',
                                                        'excelHtml5',
...
<script>
    ...
    function validasi(id) {
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('/PvitaValidasi/viewValidationModal'); ?>",
            data: {
                id_wo: id
            },
            beforeSend: function(f) {
    ...
    function filterDataTable() {
        ...
        if (parseDate(data.start_time) == null || parseDate(data.end_time) == null || parseDate(data.start_time) > parseDate(data.end_time)) {
            ...
            $.ajax({
                type: "POST",
                url: "/PvitaValidasi/ajaxDataTableValidasiFilter",
                data: data,
                cache: false,
                beforeSend: function(f) {
                    toastr.info('Mencoba mengambil data!!')
