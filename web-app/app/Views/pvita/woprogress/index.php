                          ...
                          <div class="col-sm-4">
                              ...
                              <div class="row">
                                  ...
                                  <script>
                                      function allDataWO() {
                                          $.ajax({
                                              url: "/PvitaProgress/ajaxDataTableProgress",
                                              ...
                                              success: function(data) {
                                                  ...
                                                  $('#tabelProgres').DataTable({
                                                      ajax: '<?php echo ('PvitaProgress/ajaxDataTableProgress'); ?>',
                                                      dom: 'Bfrtip',
                                                      buttons: [
                                                          'copyHtml5',
                                                          'excelHtml5',
                      ...
                      <table class="table table-hover table-bordered table-striped w-100" id="tabelProgres">
                          <thead>
                              <tr>
                                  ...
                                  <th class="text-center align-middle">Alamat Inst</th>
  ...
  <script>
      ...
      function validasi(id) {
          $.ajax({
              type: "POST",
              url: "<?php echo base_url('/PvitaProgress/viewInputModal'); ?>",
              data: {
                  id_wo: id
              },
              beforeSend: function(f) {
      ...
      function filterDataTable() {
          ...
          if (parseDate(data.start_time) == null || parseDate(data.end_time) == null || parseDate(data.start_time) > parseDate(data.end_time)) {
              ...
              $.ajax({
                  type: "POST",
                  url: "/PvitaProgress/ajaxDataTableProgressFilter",
                  data: data,
                  cache: false,
                  beforeSend: function(f) {
                      toastr.info('Mencoba mengambil data!!')
