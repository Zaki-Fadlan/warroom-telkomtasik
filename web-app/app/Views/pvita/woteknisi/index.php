          ...
          <div class="col-md-12">
                                          ...
                                          $.ajax({
                                              ...
                                              success: function(data) {
                                                  ...
                                                  $('#tabelTeknisi').DataTable({
                                                      ajax: '<?php echo ('PvitaTeknisi/ajaxDataTableTeknisi'); ?>',
                                                      dom: 'Bfrtip',
                                                      buttons: [
                                                          'copyHtml5',
                                                          'excelHtml5',
              ...
              <div class="col-md-12">
                  <div class="table-responsive">
                      <table class="table table-hover table-bordered table-striped w-100" id="tabelTeknisi">
                          <thead>
                              <tr>
                                  ...
                                  <th class="text-center align-middle">Dispatcher</th>
  ...
  <script>
      ...
      function validasi(id) {
          $.ajax({
              type: "POST",
              url: "<?php echo base_url('/PvitaTeknisi/viewSwapModal'); ?>",
              data: {
                  id_wo: id
              },
              beforeSend: function(f) {
      ...
      function filterDataTable() {
          ...
          if (parseDate(data.start_time) == null || parseDate(data.end_time) == null || parseDate(data.start_time) > parseDate(data.end_time)) {
              ...
              $.ajax({
                  type: "POST",
                  url: "/PvitaTeknisi/ajaxDataTableTeknisiFilter",
                  data: data,
                  cache: false,
                  beforeSend: function(f) {
                      toastr.info('Mencoba mengambil data!!')
