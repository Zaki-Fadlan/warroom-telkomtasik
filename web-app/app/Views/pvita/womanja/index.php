                      ...
                      <table class="table table-hover table-bordered table-striped w-100" id="tabelValidasi">
                          <thead>
                              <tr>
                                  ...
                                  <th class="text-center align-middle">Tanggal Janji</th>
              ...
              <script>
                  $(document).ready(function() {
                      $('#tabelValidasi').DataTable({
                          ...
                          scrollCollapse: true,
                          responsive: true,
                          ajax: '<?php echo ('PvitaManja/ajaxDataTableMonitor'); ?>',
                      });
                  });
              </script>
          </div>
  ...
  <script>
      function dispatch(id) {
          ...
          $.ajax({
              type: "POST",
              url: "<?php echo base_url('/Pvitamanja/viewModal'); ?>",
              data: {
                  id_wo: id
              },
              beforeSend: function(f) {
      ...
      function filterDataTable() {
          ...
          if (parseDate(data.start_time) == null || parseDate(data.end_time) == null || parseDate(data.start_time) > parseDate(data.end_time)) {
              ...
              $.ajax({
                  type: "POST",
                  url: "/Pvitamanja/ajaxDataTableMonitorFilter",
                  data: data,
                  cache: false,
                  beforeSend: function(f) {
                      toastr.info('Mencoba mengambil data!!')
