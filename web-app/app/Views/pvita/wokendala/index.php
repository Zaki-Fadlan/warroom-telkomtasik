                          ...
                          <div class="col-sm-4">
                              ...
                              <div class="row">
                                  ...
                                  <script>
                                      function allDataWO() {
                                          $.ajax({
                                              url: "/PvitaKendala/ajaxDataTableKendala",
                                              ...
                                              success: function(data) {
                                                  ...
                                                  $('#tabelKendala').DataTable({
                                                      ajax: '<?php echo ('PvitaKendala/ajaxDataTableKendala'); ?>',
                                                      dom: 'Bfrtip',
                                                      buttons: [
                                                          'copyHtml5',
                                                          'excelHtml5',
                      ...
                      <table class="table table-hover table-bordered table-striped w-100" id="tabelKendala">
                          <thead>
                              <tr>
                                  ...
                                  <th class="text-center align-middle">Waktu Validasi</th>
                                  ...
                                  <th class="text-center align-middle">Ket.Validasi</th>
                                  ...
                                  <th class="text-center align-middle">Nama Teknisi</th>
                                  <th class="text-center align-middle">Nama Dispatcher</th>
  ...
  <script>
      ...
      function dispatch(id) {
          $.ajax({
              type: "POST",
              url: "<?php echo base_url('/PvitaKendala/viewRollbackModal'); ?>",
              data: {
                  id_wo: id
              },
              beforeSend: function(f) {
      ...
      function filterDataTable() {
          ...
          if (parseDate(data.start_time) == null || parseDate(data.end_time) == null || parseDate(data.start_time) > parseDate(data.end_time)) {
              ...
              $.ajax({
                  type: "POST",
                  url: "/PvitaKendala/ajaxDataTableKendalaFilter",
                  data: data,
                  cache: false,
                  beforeSend: function(f) {
                      toastr.info('Mencoba mengambil data!!')
