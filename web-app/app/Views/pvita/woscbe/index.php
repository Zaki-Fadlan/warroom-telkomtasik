          ...
          <div class="col-md-12">
                                      ...
                                      function allDataWO() {
                                          $.ajax({
                                              ...
                                              success: function(data) {
                                                  ...
                                                  $('#tabelScbe').DataTable({
                                                      ajax: '<?php echo ('PvitaScbe/ajaxDataTableScbe'); ?>',
                                                      dom: 'Bfrtip',
                                                      buttons: [
                                                          'copyHtml5',
                                                          'excelHtml5',
              ...
              <div class="col-md-12">
                  <div class="table-responsive">
                      <table class="table table-hover table-bordered table-striped w-100" id="tabelScbe">
                          <thead>
                              <tr>
  ...
  <script>
      ...
      function dispatch(id) {
          ...
          $.ajax({
              type: "POST",
              url: "<?php echo base_url('/PvitaScbe/viewDispatchModal'); ?>",
              data: {
                  id_wo: id
              },
              beforeSend: function(f) {
      ...
      function filterDataTable() {
          ...
          if (parseDate(data.start_time) == null || parseDate(data.end_time) == null || parseDate(data.start_time) > parseDate(data.end_time)) {
              ...
              $.ajax({
                  type: "POST",
                  url: "/PvitaScbe/ajaxDataTableScbeFilter",
                  data: data,
                  cache: false,
                  beforeSend: function(f) {
                      toastr.info('Mencoba mengambil data!!')
